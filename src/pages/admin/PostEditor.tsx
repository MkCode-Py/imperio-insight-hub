    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-xl font-bold text-foreground">{isNew ? 'Novo Post' : 'Editar Post'}</h1>
      ...
      <div className="grid grid-cols-1 xl:grid-cols-3 gap-6">
        ...
        <div className="xl:col-span-2 space-y-4">
          <div className="space-y-2">
            <Label>Título</Label>
            <Input value={title} onChange={(e) => setTitle(e.target.value)} placeholder="Título do post" className="text-lg font-semibold" />
          </div>
          <div className="space-y-2">
        ...
        <div className="space-y-4">
          ...
          <div className="p-4 rounded-xl border border-border bg-card space-y-3">
            ...
            <Textarea value={seoDescription} onChange={(e) => setSeoDescription(e.target.value)} placeholder="Meta descrição" rows={2} />
          </div>
        </div>
      </div>
    </div>
